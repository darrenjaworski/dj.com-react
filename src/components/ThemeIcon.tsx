...
const ICON_PATHS: Record<ThemeIconProps["variant"], string> = {
...
const TEST_IDS: Record<ThemeIconProps["variant"], string> = {
  dark: "dark-mode-icon",
  light: "light-mode-icon",
};

const ThemeIcon = ({ variant, className, fill = "currentColor" }: ThemeIconProps) => (
  <svg
