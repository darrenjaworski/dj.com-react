...
describe("App", () => {
  ...
  it("renders the home page by default", () => {
    ...
    expect(
      screen.getByText(/Welcome. This is my home on the web/)
    ).toBeInTheDocument();
  ...
  it("navigates to journalism page when link is clicked", () => {
    ...
    expect(
      screen.getByRole("heading", { name: "journalism" })
    ).toBeInTheDocument();
  ...
  it("renders journalism sections and articles", () => {
    ...
    expect(
      screen.getByText("journalism master's research")
    ).toBeInTheDocument();

    // Check for some article links
    expect(
      screen.getByRole("link", { name: "Oklahoma Correctional Facilities" })
    ).toBeInTheDocument();
    expect(
      screen.getByRole("link", {
        name: "Online Science Communication and Public Science Literacy",
      })
    ).toBeInTheDocument();
  });
